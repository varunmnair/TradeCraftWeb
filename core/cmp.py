...
class CMPManager:
    def __init__(self, csv_path: str, broker, session_manager, market_data_connection_id: int = None, ttl: int = 600):
        ...
        self.market_data_connection_id = market_data_connection_id  # Upstox connection ID for market data
    ...
    def _fetch_bulk_quote_upstox(self, symbols):
        ...
        token = self.session_manager.get_access_token("upstox", connection_id=connection_id) if self.session_manager else None
        instrument_keys = []
        symbol_map = {}
